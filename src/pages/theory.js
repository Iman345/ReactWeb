    ...
    return (
        <div className="theory comp-space" id="Blogs">
            ...
            <div className="heading">
                <h1 className="heading">Theory Blogs</h1>
